...
The Data Mesh concept relies on the fact that previous architectural styles and approaches have failed because they leverage a centralised approach, where IT is the sole responsible to ingest, transform, curate, and serve data to business users, that creates a bottleneck in delivering value derived from data to consumers.
...
3. **Data Lake Era** -  Data Lakes became quite popular 
4. **Self Service Era** - 
5. **Data Mesh Era** - 
